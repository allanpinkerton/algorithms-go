...
set ruler
set runtimepath=~/.vim/bundle/ctrlp.vimp,~/.vim,~/.vim/bundle/ctrlp.vim-master,~/.vim/bundle/gundo,~/.vim/bundle/nerdcommenter-master,~/.vim/bundle/nerdtree-master,~/.vim/bundle/supertab-master,~/.vim/bundle/syntastic-master,~/.vim/bundle/vim-airline-master,~/.vim/bundle/vim-colors-solarized,~/.vim/bundle/vim-colors-solarized-master,~/.vim/bundle/vim-go,~/.vim/bundle/vim-surround-master,/usr/local/Cellar/macvim/7.4-73/MacVim.app/Contents/Resources/vim/vimfiles,/usr/local/Cellar/macvim/7.4-73/MacVim.app/Contents/Resources/vim/runtime,/usr/local/Cellar/macvim/7.4-73/MacVim.app/Contents/Resources/vim/vimfiles/after,~/.vim/after
set scrolloff=3
set shiftwidth=4
set showcmd
set showmatch
...
silent only
cd ~/Documents/goprojects/src/allanpinkerton.com/algorithms/sorting
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +0 sorting.go
badd +0 sorting_test.go
argglobal
silent! argdel *
argadd sorting.go
edit sorting_test.go
...
24
normal! zo
let s:l = 29 - ((27 * winheight(0) + 24) / 48)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
29
normal! 041|
lcd ~/Documents/goprojects/src/allanpinkerton.com/algorithms/sorting
wincmd w
argglobal
edit ~/Documents/goprojects/src/allanpinkerton.com/algorithms/sorting/sorting.go
